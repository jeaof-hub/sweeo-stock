...
ก่อนใช้เชิญสมาชิกทีมจริง ควรตั้งค่า **Authentication → Emails → SMTP Settings** ด้วยผู้ให้บริการส่งอีเมลของบริษัท ระบบส่งอีเมลค่าเริ่มต้นของ Supabase มีข้อจำกัดและไม่รับประกันการส่งถึงปลายทาง ตรวจกล่องจดหมายผู้รับด้วย เพราะบันทึก `mail.send` ไม่ยืนยันว่าอีเมลถึงแล้ว หากเปิดลิงก์เชิญที่หมดอายุ ให้ส่งคำเชิญใหม่ถึงบัญชีเดิมและเปิดลิงก์ในอีเมลฉบับล่าสุด
