...
8. รัน migration `08` ถึง `14` ตามลำดับเลข โดย Production ที่ผ่าน migration ก่อนหน้าแล้วให้รันเฉพาะเลขที่ยังไม่ได้รัน
...
- **การเบิกสินค้า**: คลังสินค้าส่งคำขอให้แอดมิน/เจ้าของ/ผู้ก่อตั้งอนุมัติ ส่วนแอดมินส่งให้เจ้าของ/ผู้ก่อตั้งอนุมัติ ผู้อนุมัติปรับจำนวนเพิ่มหรือลดได้ ระบบล็อกสินค้าและตรวจยอดจริงก่อนสร้างรายการส่งออกทุกครั้ง เจ้าของและผู้ก่อตั้งเบิกได้ทันที
