...
(() => {
  ...
  const english = {
    ...
    "คำขอจะถูกส่งไปรอผู้มีสิทธิ์อนุมัติ": "The request will wait for an authorized approver.", "รายการจะตัดยอดทันที": "Stock will be deducted immediately.", "จำนวนอนุมัติต้องมากกว่า 0": "Approved quantity must be above 0.", "ระบุเหตุผลที่ปฏิเสธ": "Enter a rejection reason", "ยกเลิกคำขอนี้?": "Cancel this request?", "บันทึกคำขอแล้ว": "Request saved.", "ส่งคำขอเบิกแล้ว": "Dispatch request submitted.",
