...
(() => {
  ...
  const english = {
    ...
    "สแกนรหัสสินค้า": "Scan product code", "ปิดกล้อง": "Close camera", "วางรหัสสินค้าหรือชื่อรุ่นให้อยู่ในกรอบ": "Place the product code or model inside the frame", "เปิดไฟฉาย": "Turn on flashlight", "ปิดไฟฉาย": "Turn off flashlight", "พิมพ์รหัสเอง": "Type code manually",
