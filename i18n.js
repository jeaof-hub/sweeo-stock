...
(() => {
  ...
  const english = {
    ...
    "บันทึก INV": "Record invoice", "รายการรอเปิด INV": "Lines awaiting invoice", "รอเปิด INV": "Awaiting invoice", "รายการ INV": "Invoices", "รายการที่ไม่ต้องเปิด INV": "Lines with no invoice required", "เปลี่ยนเป็นรอ INV": "Move to awaiting invoice", "ผูกรายการที่ส่งของแล้วกับ INV จาก ERP": "Link delivered lines to an invoice from ERP", "เลขที่ INV": "Invoice number", "วันที่ INV": "Invoice date", "ลูกค้าใน INV ต่างจากใบส่งของที่เลือก กรุณาตรวจสอบก่อนบันทึก": "The invoice customer differs from the selected delivery note. Review before saving.", "เลือกรายการจากใบส่งของ": "Choose delivery-note lines", "กำหนด INV": "Assign invoice", "ไม่ต้องเปิด INV": "No invoice required", "รอ INV": "Awaiting invoice", "INV บางส่วน": "Partially invoiced", "ครบ": "Complete", "เลขอ้างอิงเดิม": "Legacy reference", "แก้ไข / เพิ่มรายการ": "Edit / add lines", "ยกเลิก INV": "Cancel invoice", "ถอด": "Detach", "ไม่มีรายการรอเปิด INV": "No lines awaiting invoice", "ยังไม่มี INV": "No invoices yet", "ไม่มีรายการที่ยังไม่ผูก INV ของลูกค้านี้": "No unlinked lines for this customer", "ใช้งาน": "Active",
