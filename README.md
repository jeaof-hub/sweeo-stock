...
| ฝ่ายขาย | ดูรายละเอียดสต็อกและประวัติรับเข้า/ส่งออก รวมลูกค้าและเลขเอกสาร |
| คลังสินค้า | สิทธิ์ฝ่ายขาย พร้อมบันทึกรับเข้า/ส่งออก และลบรายการที่ตนเองบันทึกภายในวันเดียวกันตามเวลาไทย |
| ผู้จัดการ | สิทธิ์คลังสินค้า พร้อมลบรายการย้อนหลัง ปรับยอด เพิ่ม/แก้สินค้า ส่งออก Excel และดูรายการที่ถูกลบ |
| ผู้ก่อตั้ง (Foundator) | สิทธิ์ทั้งหมด พร้อมดูรายชื่อผู้ใช้ จัดการบัญชี และดูบันทึกการเปลี่ยนแปลงสต็อกทั้งหมด |
...
8. รัน `supabase/08_role_matrix_and_audit.sql` เพื่อใช้สิทธิ์ 5 ระดับและเริ่มเก็บ log; บัญชี Editor เดิมจะเป็นคลังสินค้า และ Viewer เดิมจะเป็นฝ่ายขาย
...
10. ผู้ก่อตั้งเข้าสู่ระบบเว็บ กด **บัญชี → จัดการผู้ใช้** เพื่อสร้างสมาชิก เลือกสิทธิ์ และกำหนดรหัสผ่านเริ่มต้น ไม่มีอีเมลเชิญ ผู้ก่อตั้งต้องแจ้งรหัสผ่านให้เจ้าของบัญชีด้วยช่องทางที่เลือก และสมาชิกควรเปลี่ยนรหัสผ่านหลังเข้าสู่ระบบครั้งแรก
...
- **สำรองข้อมูล**: ผู้จัดการหรือผู้ก่อตั้งกด บัญชี → ส่งออก Excel อย่างน้อยสัปดาห์ละครั้ง (แผนฟรีของ Supabase ไม่มีสำรองข้อมูลอัตโนมัติให้ดาวน์โหลด)
...
- **ดูรายการที่ถูกลบ**: ผู้จัดการและผู้ก่อตั้งใช้แท็บ **รายการที่ถูกลบ** บนเว็บ
- **ดูบันทึกการเปลี่ยนแปลง**: เฉพาะผู้ก่อตั้งใช้แท็บ **บันทึกการเปลี่ยนแปลง** บนเว็บ เริ่มเก็บข้อมูลตั้งแต่ติดตั้ง `08_role_matrix_and_audit.sql`
